...
from yolov6_obb.core.engine import Trainer
from yolov6_obb.utils.config import Config
from yolov6_obb.utils.events import LOGGER, save_yaml
from yolov6_obb.utils.envs import get_envs, select_device, set_random_seed
from yolov6_obb.utils.general import increment_name, find_latest_checkpoint


def get_args_parser(add_help=True):
    parser = argparse.ArgumentParser(description='yolov6_obb PyTorch Training', add_help=add_help)
    parser.add_argument('--data-path', default='./data/coco.yaml', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='./configs/yolov6_obbn.py', type=str, help='experiments description file')
