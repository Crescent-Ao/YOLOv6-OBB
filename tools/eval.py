...
from yolov6_obb.core.evaler import Evaler
from yolov6_obb.utils.events import LOGGER
from yolov6_obb.utils.general import increment_name
...
def get_args_parser(add_help=True):
    parser = argparse.ArgumentParser(description='yolov6_obb PyTorch Evalating', add_help=add_help)
    parser.add_argument('--data', type=str, default='./data/coco.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', type=str, default='./weights/yolov6_obbs.pt', help='model.pt path(s)')
